...
class MViewController: UIViewController{
    ...
    @IBAction func choiceMade(_ sender: UIButton) {
        ...
        if attempts > attemptsBeforeHelp{
            if storyBrain.getIsQuestion() == true {
                ...
                if dataBrain.gotData() == true{
                    dataBrain.updateData(field: "storyNum", dataInt: 1000, dataStr: "")
                    }
            ...
            dataBrain.updateData(field: "storyNum", dataInt: 0, dataStr: "")
    ...
    func getData(){
        ...
        score = dataBrain.getDBdata(dataField: "score")
        attempts = dataBrain.getDBdata(dataField: "attempt")
        storyNumberFromDb = dataBrain.getDBdata(dataField: "storyNumber")
    ...
    func  updateIfStory11Or24(){
        ...
        dataBrain.updateData(field: "attempt", dataInt: attempts+1, dataStr: "")
        if score == 10{
            updateIfScore10()
        } else{
            updateIfNotScore10()
    ...
    func updateIfScore10 (){
        ...
        if  storyBrain.getStoryNumber() == 24 {
            reviewButton.isHidden = false}
        choice2Button.isHidden = true
        dataBrain.updateData(field: "attempt", dataInt: 0, dataStr: "")
    }
    
    
    func updateIfNotScore10(){
        
        dataBrain.updateData(field: "attempt", dataInt: 1, dataStr: "")
        storyNumber = 0
        dataBrain.updateData(field: "storyNumber  ", dataInt: 0, dataStr: "")
        //updateScore(scoreToAdd: 0, resetScore: true)
        ...
        if  storyBrain.getStoryNumber() == 24 {
            ...
            dataBrain.updateData(field: "storyNumber  ", dataInt: 13, dataStr: "")
    ...
    func updateScore(scoreToAdd: Int, resetScore: Bool){
        ...
        dataBrain.updateData(field: "score", dataInt: newScore, dataStr: "")
        score = newScore
